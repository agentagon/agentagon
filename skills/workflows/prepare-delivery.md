...
Create a draft PR only after the explicit publication action with a reviewed destination and base. Selection and local delivery do not imply publication. Merge and deployment remain separate. Use the existing [delivery procedure](../fix/references/delivery.md) for engine commands and exact-parent rules.
