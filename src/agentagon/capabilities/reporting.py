...
from agentagon.domain.issues import SEVERITY, list_issues
from agentagon.storage.workspace import Workspace
from agentagon.workflows.audit.operations import findings, progress
...
def _fix_learning(run_state: dict) -> dict:
    from agentagon.capabilities.experiments.learning import pending
...
def build_fix_report(workspace: Workspace, run_state: dict) -> dict:
    ...
    """
    from agentagon.capabilities.experiments import evaluation, scoring
    from agentagon.capabilities.experiments.controls import projection
