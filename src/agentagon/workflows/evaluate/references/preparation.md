...
Preparation runs all checks and the benchmark even when a [preflight check](../../optimize/references/contract.md#preflight-checks) fails. Negative controls need full observations to prove sensitivity. Setup failures, cancellation and deadlines still stop execution.
