...
function Root() {
  ...
  return <main className="welcome" id="main"><div className="welcome-brand"><img src="/logo-split-crown-96.png" alt="" /><span>agentagon</span></div><div className="welcome-content"><p className="eyebrow">Agent improvement workspace</p><h1>Measure what matters.<br />Improve what is proven.</h1><p>Add a local agent project to begin.</p><Button onClick={() => setAddProject(true)}>Add project</Button></div>{addProject && <AddProjectModal onClose={() => setAddProject(false)} />}</main>;
}
