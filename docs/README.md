...
Start with [guided setup](init.md), then use the agent’s Improvements and Production views to follow changes beyond offline verification. The [production guide](production.md) explains opt-in local monitoring and how outcomes inform later attempts.
